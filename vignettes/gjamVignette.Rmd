...
The values in `out$parameters$betaMu` will show these omitted values as NA. The sampling for $\beta$ that conditions on zeros is described in the Supplement to Clark et al., PNAS (2020, [202003852](https://www.pnas.org/content/117/29/17074)). 
